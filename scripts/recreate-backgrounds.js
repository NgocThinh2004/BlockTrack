...
// Danh sách background cần tạo lại
const backgroundFiles = ['background1.jpg', 'background2.jpg', 'background3.jpg'];

// Xóa các file cũ nếu tồn tại
console.log('Đang xóa các file placeholder cũ...');
...
backgrounds.forEach(bg => {
  ...
  console.log(`Đã tạo background mới với thiết kế đẹp cho: ${bg.filename}`);
});

console.log('Đã tạo lại tất cả các tệp background!');
